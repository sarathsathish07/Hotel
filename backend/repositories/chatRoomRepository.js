...
export default { findChatRoomsByUserId,findChatRoomByUserIdAndHotelId,createChatRoom,updateChatRoomLastMessage ,findChatRoomsByHotelIds,findChatRoomsByHotelId,
  countUnreadMessages,updateChatRoom
};
